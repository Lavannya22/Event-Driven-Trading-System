...
// Fixed-size POD event. All engine communication flows through this struct.
// Must remain memcpy-safe: no virtual methods, no dynamic members, no padding gaps.
//
...
static_assert(sizeof(Event) == 40,                     "Event size changed — check field layout");
